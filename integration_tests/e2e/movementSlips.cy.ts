...
context('Movement slips', () => {
  ...
  it('User can view movement slips with pick-up time 10 minutes before', () => {
    ...
    movementSlipsPage.preCourtHearing(1).contains('09:45 to 10:00')
    movementSlipsPage.courtHearing('appeal', 1).contains('10:00 to 11:00')
    movementSlipsPage.postCourtHearing(1).contains('11:00 to 11:15')
